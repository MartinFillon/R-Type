...
namespace rtype::protocol {
    ...
    Packet::Packet(uint8_t opcode, Arguments arguments) : _isValid(false), _opcode(-1), _arguments({})
    {
    ...
    Packet::Arguments Packet::getArguments() const
    {
        return _arguments;
    }

    Packet::Message Packet::toMessage() const
    {
        Message message;
    ...
    bool Packet::isValidOpcode(uint8_t opcode)
    {
