    ...
    namespace systems {
        ...
        )
        {
            ...
            for (auto
                ...
                if ((position_i->_x > _width_max_limit || position_i->_x < _width_min_limit) ||
                    (position_i->_y > _height_max_limit || position_i->_y < _height_min_limit)) {
                    ...
                    for (auto
                        ...
                        if ((position_j->_x > _width_max_limit || position_j->_x < _width_min_limit) ||
                            (position_j->_y > _height_max_limit || position_j->_y < _height_min_limit)) {
